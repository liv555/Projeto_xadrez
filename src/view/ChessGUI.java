...
public class ChessGUI extends JFrame {
    ...
    private static final Color LIGHT_SQ       = new Color(230, 230, 250); // lavandajava -cp "out;resources" view.ChessGUI
    private static final Color DARK_SQ        = new Color(138, 43, 226);  // roxo intenso
    private static final Color HILITE_SELECTED = new Color(255, 0, 0);  // azul-violeta escuro
    private static final Color HILITE_LEGAL    = new Color(255, 0, 0); // azul médio
    private static final Color HILITE_LASTMOVE = new Color(186, 85, 211); // orquídea
    ...
    public ChessGUI() {
        ...
        boardPanel.setBackground(new Color(148, 0, 211)); // violeta
